...
async function handleEmailLogin(event) {
    ...
    try {
        ...
        saveSession(result);
        // Reset cart and like data on new login
        localStorage.removeItem('rahman_cart_items');
        localStorage.removeItem('rahman_favorites');
...
async function handleEmailRegister() {
    ...
    try {
        ...
        saveSession(result);
        // Reset cart and like data on new registration
        localStorage.removeItem('rahman_cart_items');
        localStorage.removeItem('rahman_favorites');
        window.location.href = REDIRECT_AFTER_LOGIN;
    } catch (error) {
...
async function handleGoogleResponse(response) {
    try {
        ...
        saveSession(result);
        // Reset cart and like data on Google login
        localStorage.removeItem('rahman_cart_items');
        localStorage.removeItem('rahman_favorites');
        window.location.href = REDIRECT_AFTER_LOGIN;
    } catch (error) {
